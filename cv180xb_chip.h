#ifndef __CV180XB_CHIP_H_
#define __CV180XB_CHIP_H_
...
#define RBR_THR_DLL	0x000		// Receive Buffer,Transmit Holding or Divisor Latch Low byte Register
#define IER_DLH		0x004		// Interrupt Enable or Divisor Latch high byte Register
#define FCR_IIR		0x008		// FIFO Control or Interrupt Identification Register
#define LCR		0x00c		// Line Control Register
#define MCR		0x010		// Modem Control Register
#define LSR		0x014		// Line Status Register
#define MSR		0x018		// Modem Status Register
#define LPDLL		0x020		// Low Power Divisor Latch (Low) Register
#define LPDLH		0x024		// Low Power Divisor Latch (High) Register
#define SRBR_STHR	0x030		// Shadow Receive/Trasnmit Buffer Register
#define FAR		0x070		// FIFO Access Register
#define TFR		0x074		// Transmit FIFO Read
#define RFW		0x078		// Receive FIFO Write
#define USR		0x07c		// UART Status Register
#define TFL		0x080		// Transmit FIFO Level
#define RFL		0x084		// Receive FIFO Level
#define SRR		0x088		// Software Reset Register
#define SRTS		0x08c		// Shadow Request to Send
#define SBCR		0x090		// Shadow Break Control Register
#define SDMAM		0x094		// Shadow DMA Mode
#define SFE		0x098		// Shadow FIFO Enable
#define SRT		0x09c		// Shadow RCVR Trigger
#define STET		0x0a0		// Shadow TX Empty Trigger
#define HTX		0x0a4		// Halt TX
#define DMASA		0x0a8		// DMA Software Acknowledge						

#define UART0_THR (UART0_BASE_ADDR + RBR_THR_DLL)
#define UART0_LSR (UART0_BASE_ADDR + LSR)

#define UART4_THR (UART4_BASE_ADDR + RBR_THR_DLL)
#define UART4_LSR (UART4_BASE_ADDR + LSR)
#define UART4_DLH (UART4_BASE_ADDR + IER_DLH)
#define UART4_LCR (UART4_BASE_ADDR + LCR)

//LCR
#define DLS_MASK			(0x3)
#define DLS_8BITS			(0x3)
#define NUM_OF_STOP_MASK		(0x1 << 2)
#define STOP_1BIT			(0x0)
#define STOP_BIT_SHIFT			(2)
#define PARITY_ENABLE_MASK		(0x1 << 3)
#define EVEN_PARITY_SEL			(0x1 << 4)
#define STICK_PARITY			(0x1 << 5)
#define BREAK_CTRL_BIT			(0x1 << 6)
#define DLAB				(0x1 << 7)

//LSR
#define DATA_READY			(0x1 << 0)
#define TRANS_HOLDING_REG_EMPTY		(0x1 << 5)

//USR
#define UART_BUSY			(0x1 << 0)
#define TRANS_FIFO_NOT_FILL		(0x1 << 1)
#define TRANS_FIFO_EMPTY		(0x1 << 2)
#define RECV_FIFO_NOT_FILL		(0x1 << 3)
#define RECV_FIFO_EMPTY			(0x1 << 4)
...
#define PINMUX_SD1_GPIO0 (PINMUX_BASE + FMUX_GPIO_FUNCSEL_SD1_GPIO0)
#define PINMUX_SD1_GPIO1 (PINMUX_BASE + FMUX_GPIO_FUNCSEL_SD1_GPIO1)

#endif //__CV180XB_CHIP_H_
